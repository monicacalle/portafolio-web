      ...
      <div className="about__grid">
        <div className="about__copy">
          ...
          <Reveal className="about__actions" delay={300}>
            <a className="btn btn--solid" href="#curriculum">
              Abrir mi CV
            </a>
    ...
    <section id="skills" className="section skills shell">
      <div className="section__head">
        ...
        <Reveal as="h2" className="section__title" delay={60}>
          Herramientas, plataformas y fortalezas
        </Reveal>
...
const GROUPS: { n: string; label: string; blurb: string; items: Project[] }[] = [
  {
    ...
    items: [
      { title: "Vibe App", tag: "UX/UI · App móvil · FemTech", img: vibe },
      { title: "Voluntee App", tag: "Investigación UX · Diseño de apps", img: voluntee },
    ],
  },
  {
    n: "02",
    ...
    items: [
      { title: "Estudio Raíz", tag: "Webflow", img: raiz, wide: true },
      { title: "Isabella Mendoza · Experiencia Capilar", tag: "WordPress", img: isa, wide: true },
      { title: "iPhone 15 Clone", tag: "React · Tailwind · GSAP", img: iphone },
    ],
  },
  {
    n: "03",
    ...
    items: [{ title: "Portafolio gráfico", tag: "Diseño gráfico · Dirección visual", img: grafico, wide: true }],
  },
];
      ...
      {GROUPS.map((g) => (
        <div key={g.n} className="pgroup">
          ...
          <div className="pgroup__grid">
            {g.items.map((p, i) => (
              <Reveal key={p.title} className={`card ${p.wide ? "card--wide" : ""}`} delay={i * 90}>
  ...
  return (
    <section id="contact" className="section contact">
      <div className="shell contact__inner">
        ...
        <Reveal delay={180}>
          <a className="contact__mail" href="mailto:monicacalle369@gmail.com">
      ...
      <footer className="footer shell">
        <p className="footer__brand serif">Mónica Calle</p>
