  ...
  */
  {
    ...
    fondo: "#888866",
    planos: [
      { src: "/edicion/plano-i-fg.avif", z: 1.2, ancho: 3.4, x: -0.6, deriva: 0.014 },
      { src: "/edicion/panel-6.avif", z: -2.6, ancho: 1.9, x: 2.7, y: 0.3, opacidad: 0.9, deriva: 0.008 },
      { src: "/edicion/plano-i-bg.avif", z: -7.5, ancho: 13, opacidad: 0.34, deriva: 0.004 },
    ],
  ...
  },
  {
    ...
    fondo: "#4E0909",
    planos: [
      { src: "/edicion/plano-ii-fg.avif", z: 0.9, ancho: 3.6, x: 0.5, deriva: 0.011 },
      { src: "/trabajo/t-esmeralda.avif", z: -2.4, ancho: 1.8, x: -2.8, y: 0.4, deriva: 0.009 },
      { src: "/trabajo/t-isabella.avif", z: -4.2, ancho: 1.3, x: 3.2, y: -0.6, opacidad: 0.85, deriva: 0.007 },
      { src: "/edicion/plano-ii-bg.avif", z: -8, ancho: 14, opacidad: 0.3, deriva: 0.003 },
    ],
  ...
  },
  {
    ...
    fondo: "#1B2C47",
    planos: [
      { src: "/edicion/ceguera-figura.avif", z: 1.5, ancho: 2.8, x: -1.9, y: -0.7, deriva: 0.015 },
      { src: "/cine/a3-loreal.avif", z: -1.8, ancho: 2.6, x: 1.8, y: 0.3, deriva: 0.009 },
      { src: "/cine/a3-ingres.avif", z: -4.4, ancho: 2.0, x: -3.4, y: 0.5, opacidad: 0.8, deriva: 0.006 },
      { src: "/edicion/plano-iii-bg.avif", z: -8.5, ancho: 15, opacidad: 0.32, deriva: 0.003 },
    ],
  ...
  },
  {
    ...
    fondo: "#141019",
    planos: [
      { src: "/edicion/plancha-vibe.avif", z: 1.1, ancho: 1.3, x: -1.5, deriva: 0.010 },
      { src: "/edicion/plancha-voluntee.avif", z: -0.6, ancho: 1.1, x: 1.4, y: 0.2, deriva: 0.010 },
      { src: "/edicion/plano-iv-bg.avif", z: -7, ancho: 13, opacidad: 0.28, deriva: 0.004 },
    ],
  ...
  },
  {
    ...
    fondo: "#6B2F14",
    planos: [
      { src: "/edicion/plano-v-fg.avif", z: 1.0, ancho: 3.8, x: 0.3, deriva: 0.012 },
      { src: "/trabajo/t-lobo.avif", z: -2.2, ancho: 1.7, x: -2.9, y: -0.3, deriva: 0.008 },
      { src: "/trabajo/t-nespresso.avif", z: -4.0, ancho: 1.5, x: 3.0, y: 0.5, opacidad: 0.85, deriva: 0.007 },
      { src: "/edicion/plano-v-bg.avif", z: -8, ancho: 14, opacidad: 0.3, deriva: 0.003 },
    ],
